...
regional_pkg_rev=$(porchctl rpkg clone -n default "https://github.com/isu-kim/catalog.git/infra/capi/nephio-workload-cluster@$REVISION" --repository mgmt regional | cut -f 1 -d ' ')
